...
export default function HubPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#16302a,_#09090b_45%)] text-white">
      <TopBar />
        ...
        <section className="grid gap-4 lg:grid-cols-[1.3fr_0.7fr]">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-7 text-zinc-300">
              Play solo, challenge CPU opponents, switch to local play for friends in the room,
              review rules before starting, and wager chips in casino-style games.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-black/30 p-6 shadow-xl">
            ...
            <div className="mt-4 space-y-3 text-sm text-zinc-300">
              ...
              <div className="rounded-xl bg-white/5 px-4 py-3">CPU Difficulty: <span className="font-semibold capitalize">{difficulty}</span></div>
              <div className="rounded-xl bg-white/5 px-4 py-3">Mode: <span className="font-semibold">{localPlay ? 'Local Play' : 'CPU / Solo'}</span></div>
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="mt-4 flex flex-wrap gap-2 text-xs text-zinc-300">
                  ...
                  <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1">
                    {game.localPlaySupported ? 'Local Play' : 'Solo Only'}
                  </span>
                </div>
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  <Link
                    href={game.route}
                    className="rounded-xl bg-gradient-to-r from-emerald-400 to-cyan-500 px-4 py-3 text-sm font-semibold text-black hover:opacity-95"
                  >
                    Play {game.name}
                  </Link>
