...
export const GAME_META: Record<GameId, GameMeta> = {
  blackjack: {
    ...
    rules: [
      ...
      'Your goal is to beat the dealer without going over 21.',
  ...
  poker: {
    ...
    name: 'Poker',
    route: '/games/poker',
    description: 'Texas Hold’em with table-style play and CPU opponents.',
    betting: true,
    localPlaySupported: true,
    cpuSupported: true,
    status: 'Playable',
  ...
  uno: {
    ...
    name: 'UNO',
    route: '/games/uno',
    description: 'Play a fast colorful shedding game with up to 6 seats.',
    betting: true,
    localPlaySupported: true,
    cpuSupported: true,
    status: 'Playable',
  ...
  baccarat: {
    ...
    description: 'Casino-style banker vs player with side bets and auto-ready table flow.',
    betting: true,
    localPlaySupported: true,
    cpuSupported: true,
    status: 'Playable',
